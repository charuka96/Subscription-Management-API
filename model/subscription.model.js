...
//Auto- calculate if renewalDate is missing
...
subcriptionSchema.pre("save", function (next) {
  if (!this.renewaltDate) {
    ...
    this.renewaltDate.startDate(
      this.renewaltDate.getDate() + renewalPeriads[this.frequency]
    );
  }

  // Auto-update the renewaldate is pass
